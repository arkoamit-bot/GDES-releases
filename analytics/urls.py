...
urlpatterns = [
    ...
    path("patient/<str:patient_id>/trajectory/", views.patient_trajectory, name="patient_trajectory"),
    path("predict/<str:patient_id>/survival/", views.predict_survival, name="predict_survival"),
